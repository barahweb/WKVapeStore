...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <form method="POST" action="/master/suppliers" enctype="multipart/form-data" class="forms-sample">
                @csrf
                <div class="mb-3">
                    <label for="nama_supplier" class="form-label">Nama Supplier</label>
                    <input type="text" class="form-control @error('nama_supplier')is-invalid             
                        @enderror" id="nama_supplier" name="nama_supplier" value="{{ old('nama_supplier') }}">
                    @error('nama_supplier')
